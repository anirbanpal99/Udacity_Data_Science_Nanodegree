...
def index():
    ...
    graphs = [
        ...
        },
        {
            ...
            'layout': {
                'title': 'Distribution of different message category',
                'yaxis': {
                    'title': "Message Count"
                },
                'xaxis': {
        ...
        },
        {
            ...
            'layout': {
                'title': 'Top 5 Message Categories Percentage',
                'yaxis': {
                    'title': "Percentage"
                },
                'xaxis': {
